...
//**************************************************************************************************
extern int8_t         vs_cs_pin ;                          // GPIO connected to CS of VS1053
extern int8_t         vs_dcs_pin ;                         // GPIO connected to DCS of VS1053
extern int8_t         vs_dreq_pin ;                        // GPIO connected to DREQ of VS1053
extern int8_t         vs_shutdown_pin ;                    // GPIO to shut down the amplifier
extern int8_t         vs_shutdownx_pin ;  
...
class VS1053
{
  ...
  protected:
    ...
    uint8_t     Spectrum_y0 = 50;//120; //bla-bla
